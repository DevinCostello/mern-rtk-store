        ...
        <main key={item._id} className={styles.item}>
            ...
            <section className={styles.iteminfo}>
                ...
                <form className={styles.form} onSubmit={e => e.preventDefault()}>
                    ...
                    <button type="submit" onClick={(e) => updateCart({ id: item._id, quantity: parseInt(e.target.form[0].value) })}>Update <GrUpdate /></button>
                    <button onClick={() => DeleteItem(item)}>Remove <BsTrash /></button>
                </form>
